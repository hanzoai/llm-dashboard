      ...
      <div style={{ width: "100%" }} className="p-8">      
        <Card>
          ...
          <Button className="mt-4">
            <a href="https://docs.hanzo.ai/docs/proxy/spending_monitoring" target="_blank">
              View Usage Guide
            </a>
          </Button>
        </Card>
      ...
      <TabGroup>
        ...
        <TabPanels>
          <TabPanel>
            ...
            <TabPanel>
            <p className="mb-2 text-gray-500 italic text-[12px]">Customers of your LLM API calls. Tracked when a `user` param is passed in your LLM calls <a className="text-blue-500" href="https://docs.hanzo.ai/docs/proxy/users" target="_blank">docs here</a></p>
              <Grid numItems={2}>
                <Col>
...
<MultiSelect
            ...
            <Grid numItems={2} className="gap-2 h-[75vh] w-full mb-4">
              ...
              <Text>Get Started Tracking cost per tag <a className="text-blue-500" href="https://docs.hanzo.ai/docs/proxy/cost_tracking" target="_blank">here</a></Text>
             <BarChart
              className="h-72"
              data={topTagsData}
              index="name"
