...
interface LLMModelNameFieldProps {
  selectedProvider: Providers;
  providerModels: string[];
  getPlaceholder: (provider: Providers) => string;
}

const LLMModelNameField: React.FC<LLMModelNameFieldProps> = ({
  selectedProvider,
  providerModels, 
  getPlaceholder,
}) => {
  ...
  return (
    <>
      <Form.Item
        label="LLM Model Name(s)"
        tooltip="Actual model name used for making llm.completion() / llm.embedding() call."
        className="mb-0"
      >
        <Form.Item
          name="model"
      ...
      <Row>
        ...
        <Col span={10}>
          <Text className="mb-3 mt-1">
            Actual model name used for making llm.completion() call. We loadbalance models with the same public name
          </Text>
        </Col>
      </Row>
    </>
...
export default LLMModelNameField;